...
const MainSection: React.FC = () => {
  return (
    <section>
      <div className="py-8 mx-6 border-t-2">
        ...
        <div className="py-3">
          ...
          <p className="text-lg">
            ...
            <a className="text-blue-700 underline hover:text-blue-500"> Learn more about our top-ranked specialties.</a>
          </p>
        </div>
        <SectionBtn title="Why choose Mayo Clinic" />
      </div>
      <Image
        src="/home/images/healing-starts-here.jpg"
        alt="Image 1"
        width={450}
        height={48}
      />
      ...
      <Image
        src="/home/images/world-class-care.jpg"
        alt="Image 2"
        width={450}
        height={48}
      />
